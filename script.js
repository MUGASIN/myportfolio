...
function initNavbar() {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', () => {
            ...
            navMenu.classList.remove('ac/tive');
        });
    });
...
//     emailjs.init("pBq65MVXRcrcGOiQf"); // put your EmailJS public key
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    emailjs.init("pBq65MVXRcrcGOiQf");
    ...
    form.addEventListener("submit", function (e) {
        ...
        emailjs.send("service_hfh78wb", "template_a2c0stm", formData)
            .then(() => {
            ...
            .catch((error) => {
                msgDiv.textContent = "❌ Failed to send message: " + error.text;
                msgDiv.style.color = "red";
                console.error(error);
            })
            .finally(() => {
...
function initResumeDownload() {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener("click", function () {
            ...
            link.href = "MugasinCv.pdf"; // resume file path
